...
import cold1 from '../images/cold1.png'
import cold2 from '../images/cold2.png'
const ColdLeaser = ({apointPop,setApointPop}) => {
  ...
  return (
    <>
            <div className="medicine-back medicine-back4">
            ...
            <div className="about-institute">
                ...
                <img className='sov-img'  src={btn} alt="" />
                     <img className='dov-img' src={cold1} alt="dotor" />
                </div>
            </div>
                  ...
                  <div key={val.id} className="card card1">
                   ...
                   <div className="name-card">
                     <div className="text-card">
                       <h3>{val.name}</h3>
                       <p>Senior Cold Laser Therapy Expert at Major</p>
                       <p>Hospital Mumbai</p>
                       {/* <p>{val.content1}</p> */}
                     </div>
            ...
            <div className='our-blogs our-blogs2 py-2  px-10'>
              ...
              <h2 className='text-center text-3xl font-bold gast'> Cold Laser Therapy Blogs</h2>
