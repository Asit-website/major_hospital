...
const InternalMedicine = () => {
    const [item,setItem] = useState(opthoApi);
  return (
    <>
        <Navbar/>
            ...
            <div className="treats">
                ...
                <div className='consult'>
                          <img src={Frame} alt="" />
                          <h3 className='exy'>Consult with experienced doctors</h3>
                          <div className="sard">
            {
              item.map(val=>{
                return(
                ...
                <p className='see_more'>See More Doctors</p>
                     </div>
                     </div>
            ...
            <div className='success'>
                ...
                <p>See how Medanta’s doctors treated patients using advanced technologies and <br /> sophisticated procedures.</p>
